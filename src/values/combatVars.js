...
export const Targets = {
	...
	otherminions: CanTargetAllyMinions + NotTargetSelf, //+not self
	...
	epicenter:
		CanTargetAllyLeader + CanTargetAllyMinions + CanTargetEnemyLeader + CanTargetEnemyMinions + NotTargetSelf, //+not self
};
